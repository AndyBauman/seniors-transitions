  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(45, 62, 80, 0.75), rgba(45, 62, 80, 0.75)), url('https://images.unsplash.com/photo-1564013799919-ab600027ffc6?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')`,
